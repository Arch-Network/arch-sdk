...
impl Account {
    ...
    pub fn is_owned_by_system_program(&self) -> bool {
        self.owner == arch_program::system_program::SYSTEM_PROGRAM_ID
    }
}
...
pub fn is_rent_exempt_account(lamports: u64, account_data_len: usize) -> bool {
    lamports >= arch_program::rent::minimum_rent(account_data_len)
}
